...
import VHSGif from '../../assets/gif/background5.gif'

const useStyles = makeStyles({
  dialogBackground: {
    backgroundImage: `linear-gradient(to bottom right, rgba(0, 0, 0, 0.6) 60%, transparent), url(${VHSGif})`,
...
function Countdown() {
  ...
  useGsap(rootRef.current, () => {
    const texts = [
      ...
      "PRAXIS 2024",
      "When? When?",
      "21, 22 and 23 February", // Assuming you have hours, minutes, and seconds defined
    ];
    ...
    tl.to(textSelector, {
      ...
      y: 50,
      duration: 0.5,
      onComplete: () => setText("Website Releasing in"),
      ease: "power3",
    })
      .from(textSelector, { opacity: 0, y: -50, duration: 0.5 })
