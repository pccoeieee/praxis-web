...
import Background from '../../assets/gif/background3.gif';
...
const Hero = () => {
  ...
  return (
    <Box
      ref={rootRef}
      sx={{
        backgroundImage: `linear-gradient(to bottom right, rgba(0, 0, 0, 0.6) 60%, transparent), url(${Background})`, // Gradient from top left to bottom right, darkening the background image
        padding: "80px 0",
        backgroundSize: "cover",
